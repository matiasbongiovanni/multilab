...
const clients = [
  ...
  { name: "Alimentación del Centro SA", logo: null, useImg: false },
  { name: "Canteras Diquecito SA", logo: "/clientes/alimentacion-del-centro.png", useImg: true },
  { name: "Cantesur SA", logo: "/clientes/canteras-diquecito.png", useImg: true },
  { name: "Dicca ICSA", logo: null, useImg: false },
  { name: "Cía. Cervecera Argentina SRL", logo: "/clientes/clinica-reyes-giobellina.png", useImg: true },
  { name: "Clínica de Ojos Reyes Giobellina", logo: "/clientes/ledesma.png", useImg: true },
  { name: "La Casa de las Chopperas SRL", logo: null, useImg: false },
  { name: "Ledesma SAIC", logo: "/clientes/servicios-radio-tv-unc.png", useImg: true },
  { name: "Servicios de Radio y TV (UNC)", logo: null, useImg: false },
  { name: "Maderas Misioneras SRL", logo: "/clientes/silcar.png", useImg: true },
  { name: "Peri S.A.", logo: "/clientes/maderas-misioneras.png", useImg: true },
  { name: "Silcar SAS", logo: null, useImg: false },
