      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center">
          ...
          <motion.div initial={shouldReduceMotion ? {} : { opacity: 0, y: 30 }} whileInView={shouldReduceMotion ? {} : { opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }}
            ...
            <p className="text-[#1a2e1a] text-lg max-w-2xl leading-relaxed mb-10 font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link href="/mis-estudios" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-green-50 border border-green-200 text-[#2E7D32] font-semibold rounded-2xl hover:bg-green-100 hover:border-green-300 transition-all duration-300 hover:-translate-y-1">
                Ver mis informes
              </Link>
            </div>
          </motion.div>
