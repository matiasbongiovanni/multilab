        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              ...
              <p className="text-[10px] text-[#1a2e1a] font-bold uppercase tracking-[0.15em]">
                Años de ciencia
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#1a2e1a] text-lg leading-relaxed font-light">
              ...
              {values.map((value, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#1a2e1a] leading-relaxed font-light">
                      {value.desc}
                    </p>
                  </div>
                </motion.div>
